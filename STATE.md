...
> 上次更新：2026-04-06（UI 重構進行中，已完成 4/5 項）| 分支：`claude/analyze-test-coverage-070Kf`
...
## UI 重構進度（2026-04-06，進行中）

| # | 項目 | 狀態 | 說明 |
|---|---|---|---|
| 1 | Tab 重組為 5 主 Tab | ✅ 完成 | 總經/熱力板塊/台股/ETF/資料診斷，台股與ETF各含巢狀子Tab |
| 2 | 移除交易日記 Tab | ✅ 完成 | `with tab6_journal:` 整塊刪除（原 5164~5591 行） |
| 3 | 移除總經重複 Section 八 | ✅ 完成 | 持股建議比例區塊刪除（原 3102~3163 行），保留保守「今日唯一結論」 |
| 4 | 個股分析頂部加趨勢儀表板 | ✅ 完成 | 現價/漲跌%/MA20/MA60/MA120/趨勢燈號大卡片 |
...
| 優先 | 項目 |
|---|---|
| 🔴 高 | 完成 ETF 折溢價買賣訊號強化（etf_dashboard.py ~line 472） |
| 低 | commit & push UI 重構變更，建立 PR |
