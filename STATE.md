...
- **進度**: 持續修復中
- **分支**: main（最新）
- **最新 commit**: `c92b7d7` — 三率+FGMS前瞻動能分數（合約負債/存貨背離/三率/資本支出）
...
| `c92b7d7` | **三率+FGMS前瞻動能**: data_loader 新增 get_quarterly_bs_cf() + 三率(營業利益率/淨利率) + scoring_engine.calc_forward_momentum_score() 四維度加權 |
